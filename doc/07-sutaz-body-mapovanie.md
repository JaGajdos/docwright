...
**Odporúčanie:** **GitHub Pages** + **Railway** (Agent + GitHub MCP + LLM) — sync generate + 6 b. Lower ceiling. Inštalácia: [`09`](./09-nasadenie.md).  
Iný BE host (Fly, Render, Cloud Run, …) je možný — Railway nie je hardcodované: [`09` §2.7](./09-nasadenie.md#27-iný-backend-host-nie-railway).
